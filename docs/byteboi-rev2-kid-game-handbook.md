...
- **Animated GIF preview:** ![Boxxle animated preview](assets/byteboi-rev2-handbook-gifs/gb/boxxle.gif)
...
- **Animated GIF preview:** ![Catrap animated preview](assets/byteboi-rev2-handbook-gifs/gb/catrap.gif)
...
- **Animated GIF preview:** ![Dr. Mario animated preview](assets/byteboi-rev2-handbook-gifs/gb/dr-mario.gif)
...
- **ByteBoi controls:** D-pad move, A/B action, Start (Select+A) pause.
- **Animated GIF preview:** ![Kwirk - He's A-maze-ing! animated preview](assets/byteboi-rev2-handbook-gifs/gb/kwirk-hes-a-maze-ing.gif)
...
- **Animated GIF preview:** ![Mario's Picross animated preview](assets/byteboi-rev2-handbook-gifs/gb/marios-picross.gif)
...
- **Animated GIF preview:** ![Mole Mania animated preview](assets/byteboi-rev2-handbook-gifs/gb/mole-mania.gif)
...
- **Animated GIF preview:** ![Pokemon Yellow animated preview](assets/byteboi-rev2-handbook-gifs/gb/pokemon-yellow.gif)
...
- **Animated GIF preview:** ![Solitaire FunPak animated preview](assets/byteboi-rev2-handbook-gifs/gb/solitaire-funpak.gif)
...
- **ByteBoi controls:** D-pad move/cursor, A confirm, B cancel, Start (Select+A) menu.
- **Animated GIF preview:** ![Azure Dreams animated preview](assets/byteboi-rev2-handbook-gifs/gbc/azure-dreams.gif)
...
- **Animated GIF preview:** ![Bomberman Quest animated preview](assets/byteboi-rev2-handbook-gifs/gbc/bomberman-quest.gif)
...
- **Animated GIF preview:** ![Dragon Warrior Monsters animated preview](assets/byteboi-rev2-handbook-gifs/gbc/dragon-warrior-monsters.gif)
...
- **ByteBoi controls:** D-pad move/cursor, A confirm, B cancel, Start (Select+A) menu.
- **Animated GIF preview:** ![Dragon Warrior Monsters 2 - Cobi's Journey animated preview](assets/byteboi-rev2-handbook-gifs/gbc/dragon-warrior-monsters-2-cobis-journey.gif)
...
- **ByteBoi controls:** D-pad move/cursor, A confirm, B cancel, Start (Select+A) menu.
- **Animated GIF preview:** ![Dragon Warrior Monsters 2 - Tara's Adventure animated preview](assets/byteboi-rev2-handbook-gifs/gbc/dragon-warrior-monsters-2-taras-adventure.gif)
...
- **Animated GIF preview:** ![Harvest Moon GBC animated preview](assets/byteboi-rev2-handbook-gifs/gbc/harvest-moon-gbc.gif)
...
- **ByteBoi controls:** D-pad move, A use tool/confirm, B back, Start (Select+A) menu.
- **Animated GIF preview:** ![Harvest Moon 2 GBC animated preview](assets/byteboi-rev2-handbook-gifs/gbc/harvest-moon-2-gbc.gif)
...
- **Animated GIF preview:** ![Heroes of Might and Magic animated preview](assets/byteboi-rev2-handbook-gifs/gbc/heroes-of-might-and-magic.gif)
...
- **Animated GIF preview:** ![The Legend of Zelda: Link's Awakening DX animated preview](assets/byteboi-rev2-handbook-gifs/gbc/the-legend-of-zelda-links-awakening-dx.gif)
...
- **ByteBoi controls:** D-pad move, A/B item+sword, Start (Select+A) inventory/menu.
- **Animated GIF preview:** ![The Legend of Zelda: Oracle of Ages animated preview](assets/byteboi-rev2-handbook-gifs/gbc/the-legend-of-zelda-oracle-of-ages.gif)
...
- **ByteBoi controls:** D-pad move, A/B item+sword, Start (Select+A) inventory/menu.
- **Animated GIF preview:** ![The Legend of Zelda: Oracle of Seasons animated preview](assets/byteboi-rev2-handbook-gifs/gbc/the-legend-of-zelda-oracle-of-seasons.gif)
...
- **Animated GIF preview:** ![Lemmings & Oh No! More Lemmings animated preview](assets/byteboi-rev2-handbook-gifs/gbc/lemmings-and-oh-no-more-lemmings.gif)
...
- **ByteBoi controls:** D-pad move/cursor, A confirm/talk, B back, Start (Select+A) menu.
- **Animated GIF preview:** ![Lufia - The Legend Returns animated preview](assets/byteboi-rev2-handbook-gifs/gbc/lufia-the-legend-returns.gif)
...
- **ByteBoi controls:** D-pad move/cursor, A confirm, B cancel, Start (Select+A) menu.
- **Animated GIF preview:** ![Metal Walker animated preview](assets/byteboi-rev2-handbook-gifs/gbc/metal-walker.gif)
...
- **Animated GIF preview:** ![Pokemon Crystal animated preview](assets/byteboi-rev2-handbook-gifs/gbc/pokemon-crystal.gif)
...
- **Animated GIF preview:** ![Pokemon Puzzle Challenge animated preview](assets/byteboi-rev2-handbook-gifs/gbc/pokemon-puzzle-challenge.gif)
...
- **Animated GIF preview:** ![Pokemon Trading Card Game animated preview](assets/byteboi-rev2-handbook-gifs/gbc/pokemon-trading-card-game.gif)
...
- **Animated GIF preview:** ![Puzzle Master animated preview](assets/byteboi-rev2-handbook-gifs/gbc/puzzle-master.gif)
...
- **Animated GIF preview:** ![Survival Kids animated preview](assets/byteboi-rev2-handbook-gifs/gbc/survival-kids.gif)
...
- **Animated GIF preview:** ![Tetris DX animated preview](assets/byteboi-rev2-handbook-gifs/gbc/tetris-dx.gif)
...
- **Animated GIF preview:** ![Warlocked animated preview](assets/byteboi-rev2-handbook-gifs/gbc/warlocked.gif)
...
- **Animated GIF preview:** ![Yu-Gi-Oh! - Dark Duel Stories animated preview](assets/byteboi-rev2-handbook-gifs/gbc/yu-gi-oh-dark-duel-stories.gif)
...
- **Animated GIF preview:** ![Adventures of Lolo animated preview](assets/byteboi-rev2-handbook-gifs/nes/adventures-of-lolo.gif)
...
- **ByteBoi controls:** D-pad move, A action, B back, Start (Select+A) pause.
- **Animated GIF preview:** ![Adventures of Lolo 2 animated preview](assets/byteboi-rev2-handbook-gifs/nes/adventures-of-lolo-2.gif)
...
- **ByteBoi controls:** D-pad move, A action, B back, Start (Select+A) pause.
- **Animated GIF preview:** ![Adventures of Lolo 3 animated preview](assets/byteboi-rev2-handbook-gifs/nes/adventures-of-lolo-3.gif)
...
- **Animated GIF preview:** ![Battle Chess animated preview](assets/byteboi-rev2-handbook-gifs/nes/battle-chess.gif)
...
- **ByteBoi controls:** D-pad cursor, A select/confirm, B cancel, Start (Select+A) options.
- **Animated GIF preview:** ![The Chessmaster animated preview](assets/byteboi-rev2-handbook-gifs/nes/the-chessmaster.gif)
...
- **Animated GIF preview:** ![Desert Commander animated preview](assets/byteboi-rev2-handbook-gifs/nes/desert-commander.gif)
...
- **ByteBoi controls:** D-pad move/drop, A/B rotate, Start (Select+A) pause.
- **Animated GIF preview:** ![Dr. Mario animated preview](assets/byteboi-rev2-handbook-gifs/nes/dr-mario.gif)
...
- **Animated GIF preview:** ![Genghis Khan animated preview](assets/byteboi-rev2-handbook-gifs/nes/genghis-khan.gif)
...
- **Animated GIF preview:** ![Kirby's Adventure animated preview](assets/byteboi-rev2-handbook-gifs/nes/kirbys-adventure.gif)
...
- **ByteBoi controls:** D-pad cursor/map, A confirm, B back, Start (Select+A) menu.
- **Animated GIF preview:** ![Nobunaga's Ambition animated preview](assets/byteboi-rev2-handbook-gifs/nes/nobunagas-ambition.gif)
...
- **Animated GIF preview:** ![Pipe Dream animated preview](assets/byteboi-rev2-handbook-gifs/nes/pipe-dream.gif)
...
- **Animated GIF preview:** ![Rampart animated preview](assets/byteboi-rev2-handbook-gifs/nes/rampart.gif)
...
- **ByteBoi controls:** D-pad cursor/map, A confirm, B back, Start (Select+A) menu.
- **Animated GIF preview:** ![Romance of the Three Kingdoms II animated preview](assets/byteboi-rev2-handbook-gifs/nes/romance-of-the-three-kingdoms-ii.gif)
...
- **Animated GIF preview:** ![Yoshi's Cookie animated preview](assets/byteboi-rev2-handbook-gifs/nes/yoshis-cookie.gif)
...
- **Animated GIF preview:** ![Aerobiz animated preview](assets/byteboi-rev2-handbook-gifs/md/aerobiz.gif)
...
- **ByteBoi controls:** D-pad cursor, A confirm/action, B back, Start (Select+A) menu.
- **Animated GIF preview:** ![Aerobiz Supersonic animated preview](assets/byteboi-rev2-handbook-gifs/md/aerobiz-supersonic.gif)
...
- **ByteBoi controls:** D-pad move, A/B rotate, Start (Select+A) pause.
- **Animated GIF preview:** ![Columns animated preview](assets/byteboi-rev2-handbook-gifs/md/columns.gif)
...
- **ByteBoi controls:** D-pad move, A/B rotate, Start (Select+A) pause.
- **Animated GIF preview:** ![Dr. Robotnik's Mean Bean Machine animated preview](assets/byteboi-rev2-handbook-gifs/md/dr-robotniks-mean-bean-machine.gif)
...
- **Animated GIF preview:** ![General Chaos animated preview](assets/byteboi-rev2-handbook-gifs/md/general-chaos.gif)
...
- **ByteBoi controls:** D-pad cursor, A assign skill, B cancel, Start (Select+A) pause.
- **Animated GIF preview:** ![Lemmings 2 - The Tribes animated preview](assets/byteboi-rev2-handbook-gifs/md/lemmings-2-the-tribes.gif)
...
- **Animated GIF preview:** ![Mega-lo-Mania animated preview](assets/byteboi-rev2-handbook-gifs/md/mega-lo-mania.gif)
...
- **Animated GIF preview:** ![Phantasy Star IV animated preview](assets/byteboi-rev2-handbook-gifs/md/phantasy-star-iv.gif)
...
- **Animated GIF preview:** ![Populous animated preview](assets/byteboi-rev2-handbook-gifs/md/populous.gif)
...
- **Animated GIF preview:** ![Shining Force animated preview](assets/byteboi-rev2-handbook-gifs/md/shining-force.gif)
...
- **Animated GIF preview:** ![Shining Force II (covers both ROM variants in folder) animated preview](assets/byteboi-rev2-handbook-gifs/md/shining-force-ii.gif)
...
- **Animated GIF preview:** ![Starflight animated preview](assets/byteboi-rev2-handbook-gifs/md/starflight.gif)
...
- **Animated GIF preview:** ![Theme Park animated preview](assets/byteboi-rev2-handbook-gifs/md/theme-park.gif)
...
- **ByteBoi controls:** D-pad move, A/B rotate, Start (Select+A) pause.
- **Animated GIF preview:** ![Baku Baku Animal animated preview](assets/byteboi-rev2-handbook-gifs/gg/baku-baku-animal.gif)
...
- **Animated GIF preview:** ![Castle of Illusion Starring Mickey Mouse animated preview](assets/byteboi-rev2-handbook-gifs/gg/castle-of-illusion-starring-mickey-mouse.gif)
...
- **ByteBoi controls:** D-pad move, A/B rotate, Start (Select+A) pause.
- **Animated GIF preview:** ![Columns animated preview](assets/byteboi-rev2-handbook-gifs/gg/columns.gif)
...
- **Animated GIF preview:** ![Crystal Warriors animated preview](assets/byteboi-rev2-handbook-gifs/gg/crystal-warriors.gif)
...
- **ByteBoi controls:** D-pad move/cursor, A confirm/talk, B back, Start (Select+A) menu.
- **Animated GIF preview:** ![Defenders of Oasis animated preview](assets/byteboi-rev2-handbook-gifs/gg/defenders-of-oasis.gif)
...
- **ByteBoi controls:** D-pad move, A/B rotate, Start (Select+A) pause.
- **Animated GIF preview:** ![Dr. Robotnik's Mean Bean Machine animated preview](assets/byteboi-rev2-handbook-gifs/gg/dr-robotniks-mean-bean-machine.gif)
...
- **Animated GIF preview:** ![Dragon Crystal animated preview](assets/byteboi-rev2-handbook-gifs/gg/dragon-crystal.gif)
...
- **Animated GIF preview:** ![GG Aleste animated preview](assets/byteboi-rev2-handbook-gifs/gg/gg-aleste.gif)
...
- **ByteBoi controls:** D-pad fly, A shoot, B special, Start (Select+A) pause.
- **Animated GIF preview:** ![GG Aleste II animated preview](assets/byteboi-rev2-handbook-gifs/gg/gg-aleste-ii.gif)
...
- **Animated GIF preview:** ![Land of Illusion Starring Mickey Mouse animated preview](assets/byteboi-rev2-handbook-gifs/gg/land-of-illusion-starring-mickey-mouse.gif)
...
- **ByteBoi controls:** D-pad cursor, A assign skill, B cancel, Start (Select+A) pause.
- **Animated GIF preview:** ![Lemmings animated preview](assets/byteboi-rev2-handbook-gifs/gg/lemmings.gif)
...
- **Animated GIF preview:** ![Ristar animated preview](assets/byteboi-rev2-handbook-gifs/gg/ristar.gif)
...
- **ByteBoi controls:** D-pad cursor, A confirm, B cancel, Start (Select+A) menu.
- **Animated GIF preview:** ![Royal Stone - Hirakareshi Toki no Tobira animated preview](assets/byteboi-rev2-handbook-gifs/gg/royal-stone-hirakareshi-toki-no-tobira.gif)
...
- **ByteBoi controls:** D-pad cursor/units, A confirm action, B cancel, Start (Select+A) battle menu.
- **Animated GIF preview:** ![Shining Force - The Sword of Hajya animated preview](assets/byteboi-rev2-handbook-gifs/gg/shining-force-the-sword-of-hajya.gif)
...
- **ByteBoi controls:** D-pad cursor/units, A confirm, B cancel, Start (Select+A) menu.
- **Animated GIF preview:** ![Shining Force Gaiden - Final Conflict animated preview](assets/byteboi-rev2-handbook-gifs/gg/shining-force-gaiden-final-conflict.gif)
...
- **Animated GIF preview:** ![Sylvan Tale animated preview](assets/byteboi-rev2-handbook-gifs/gg/sylvan-tale.gif)
...
- **Animated GIF preview:** ![Tails Adventure animated preview](assets/byteboi-rev2-handbook-gifs/gg/tails-adventure.gif)
...
# 🧠 ByteBoi Rev2 Trading / Tycoon / Board / Card Handbook

Focused companion guide for the curated strategy-style picks now on SD.
...
### 🎮 Jinsei Game
- **About:** Japanese life-simulation board game.
- **ROM on SD:** Jinsei Game (Japan) (SGB Enhanced).zip
- **How it plays:** Turn-based progress through life events and choices.
- **Getting started:** Build stable income first, then take higher-risk choices.
- **ByteBoi controls:** D-pad cursor, A confirm, B cancel, Start (Select+A) menu.

### 🎮 Momotarou Dentetsu Jr.
- **About:** Family-friendly railway tycoon board game.
- **ROM on SD:** Momotarou Dentetsu jr. - Zenkoku Ramen Meguri no Maki (Japan) (SGB Enhanced).zip
- **How it plays:** Buy routes/stations and out-earn rivals.
- **Getting started:** Connect short profitable routes before expanding far.
- **ByteBoi controls:** D-pad map/cursor, A confirm, B back, Start (Select+A) menu.

### 🎮 Monopoly
- **About:** Classic property-trading board game.
- **ROM on SD:** Monopoly (USA).zip
- **How it plays:** Buy sets, build houses, collect rent.
- **Getting started:** Prioritize completing one color set early.
- **ByteBoi controls:** D-pad cursor, A confirm, B cancel, Start (Select+A) menu.

### 🎮 Trump Collection GB
- **About:** Card game collection (poker and more).
- **ROM on SD:** Trump Collection GB (Japan).zip
- **How it plays:** Choose card mode and play vs AI.
- **Getting started:** Learn hand rankings and bet conservatively at first.
- **ByteBoi controls:** D-pad cursor, A confirm, B cancel, Start (Select+A) menu.

### 🎮 Vegas Stakes
- **About:** Casino simulation with table/card games.
- **ROM on SD:** Vegas Stakes (USA, Europe) (SGB Enhanced).zip
- **How it plays:** Win across casino events to grow bankroll.
- **Getting started:** Stick to low bets until you know each game's odds.
- **ByteBoi controls:** D-pad cursor, A confirm, B cancel, Start (Select+A) menu.
...
### 🎮 Battleship
- **About:** Grid-based naval strategy.
- **ROM on SD:** Battleship (USA, Europe) (GB Compatible).zip
- **How it plays:** Hide ships and call shots turn-by-turn.
- **Getting started:** Space ships apart and fire in patterns.
- **ByteBoi controls:** D-pad cursor, A confirm shot, B cancel, Start (Select+A) menu.

### 🎮 Dokapon! - Millennium Quest
- **About:** Fantasy board-RPG hybrid.
- **ROM on SD:** Dokapon! - Millennium Quest (Japan) (SGB Enhanced) (GB Compatible).zip
- **How it plays:** Move across board nodes, fight, and gear up.
- **Getting started:** Buy defense early before taking boss routes.
- **ByteBoi controls:** D-pad move/cursor, A confirm, B back, Start (Select+A) menu.

### 🎮 Hexcite - Wrath of the Demon
- **About:** Board-style wizard duel game.
- **ROM on SD:** Hexcite - The Shapes of Victory (USA, Europe) (SGB Enhanced) (GB Compatible).zip
- **How it plays:** Move, cast spells, and control engagements.
- **Getting started:** Grab utility spells first; avoid early all-ins.
- **ByteBoi controls:** D-pad cursor, A confirm, B cancel, Start (Select+A) menu.

### 🎮 Hoyle Card Games
- **About:** Classic card suite (poker/blackjack/bridge, etc.).
- **ROM on SD:** Hoyle Card Games (USA).zip
- **How it plays:** Select mode and play structured card rules.
- **Getting started:** Start with low-stakes tables to learn pacing.
- **ByteBoi controls:** D-pad cursor, A confirm, B cancel, Start (Select+A) menu.

### 🎮 Hoyle Casino
- **About:** Multi-game casino package.
- **ROM on SD:** Hoyle Casino (USA).zip
- **How it plays:** Rotate across casino games with bankroll management.
- **Getting started:** Use roulette/blackjack to manage risk.
- **ByteBoi controls:** D-pad cursor, A confirm, B cancel, Start (Select+A) menu.

### 🎮 Monster Rancher Battle Card GB
- **About:** Deck-building card battler.
- **ROM on SD:** Monster Rancher Battle Card GB (USA) (SGB Enhanced) (GB Compatible).zip
- **How it plays:** Build monster card decks and duel turn-by-turn.
- **Getting started:** Focus one deck archetype before splashing cards.
- **ByteBoi controls:** D-pad cursor, A confirm/play, B cancel, Start (Select+A) menu.
...
### 🎮 Peek-A-Boo Poker
- **About:** Poker-focused card game.
- **ROM on SD:** Peek-A-Boo Poker (USA) (Unl).zip
- **How it plays:** Turn-based betting and hand evaluation.
- **Getting started:** Protect bankroll and avoid overbetting weak hands.
- **ByteBoi controls:** D-pad cursor, A confirm/bet, B fold/back, Start (Select+A) menu.

### 🎮 Shanghai - Shanghai Tycoon
- **About:** Mahjong-style tile-pair puzzle.
- **ROM on SD:** Shanghai Daheng (Shanghai Tycoon) (China) (Unl).zip
- **How it plays:** Match open tile pairs to clear layouts.
- **Getting started:** Clear top-locking tiles first to open options.
- **ByteBoi controls:** D-pad cursor, A select/pair, B deselect, Start (Select+A) pause.

### 🎮 Sugoro Quest - Dice no Senshi
- **About:** Dice-driven fantasy board adventure.
- **ROM on SD:** Sugoro Quest - Dice no Senshitachi (Japan).zip
- **How it plays:** Move on board paths, fight, and collect resources.
- **Getting started:** Keep healing stocked and avoid risky routes early.
- **ByteBoi controls:** D-pad move/cursor, A confirm, B cancel, Start (Select+A) menu.

### 🎮 Taiwan 16 Maque
- **About:** Mahjong tile strategy title.
- **ROM on SD:** Taiwan 16 Maque (Asia) (v1.1) (Unl).zip
- **How it plays:** Build/sculpt winning tile patterns.
- **Getting started:** Prioritize open, flexible waits over narrow hands.
- **ByteBoi controls:** D-pad cursor, A select/discard, B back, Start (Select+A) menu.

### 🎮 Tenkaichi Bushi
- **About:** Historical strategy board/war game.
- **ROM on SD:** Tenkaichi Bushi - Keru Naguuru (Japan).zip
- **How it plays:** Territory control and tactical turn planning.
- **Getting started:** Secure economy nodes before long offense lines.
- **ByteBoi controls:** D-pad cursor/map, A confirm, B back, Start (Select+A) menu.
...
### 🎮 Battleship
- **About:** Naval board strategy adaptation.
- **ROM on SD:** Battleship - The Classic Naval Combat Game (USA).zip
- **How it plays:** Place ships and call target coordinates.
- **Getting started:** Keep formation unpredictable; hunt in checker patterns.
- **ByteBoi controls:** D-pad cursor, A confirm shot, B cancel, Start (Select+A) menu.

### 🎮 Casino FunPak
- **About:** Casino card/table compilation.
- **ROM on SD:** Casino FunPak (USA).zip
- **How it plays:** Rotate game modes to build virtual bankroll.
- **Getting started:** Start conservative and cap losses per session.
- **ByteBoi controls:** D-pad cursor, A confirm/bet, B cancel, Start (Select+A) menu.

### 🎮 Chessmaster
- **About:** Classic chess with AI difficulty options.
- **ROM on SD:** Chessmaster, The (USA, Europe, Brazil) (En).zip
- **How it plays:** Turn-based chess rules and tactical planning.
- **Getting started:** Develop pieces first; don’t rush queen attacks.
- **ByteBoi controls:** D-pad cursor, A select/confirm, B cancel, Start (Select+A) options.

### 🎮 Jeopardy!
- **About:** Trivia quiz adaptation.
- **ROM on SD:** Jeopardy! (USA).zip
- **How it plays:** Pick categories and respond in question format.
- **Getting started:** Build score from low-value clues before risking big.
- **ByteBoi controls:** D-pad cursor, A select/confirm, B back, Start (Select+A) menu.

### 🎮 Shanghai II
- **About:** Tile-pair matching puzzle strategy.
- **ROM on SD:** Shanghai II (Japan).zip
- **How it plays:** Remove matching free tiles to clear boards.
- **Getting started:** Prioritize moves that unlock buried layers.
- **ByteBoi controls:** D-pad cursor, A select/pair, B deselect, Start (Select+A) pause.

### 🎮 Taisen Mahjong HaoPai
- **About:** Competitive mahjong strategy game.
- **ROM on SD:** Taisen Mahjong HaoPai (Japan).zip
- **How it plays:** Draw/discard to complete valid winning hands.
- **Getting started:** Learn core yaku first and avoid overcommitting early.
- **ByteBoi controls:** D-pad cursor, A select/discard, B back, Start (Select+A) menu.

---

## ✅ Notes
- This file is a focused companion to the main kid handbook.
- It tracks only trading/tycoon/board/card-focused picks.